...
<div id="node-<?php print $node->nid; ?>" style="margin-top:30px;" class="<?php print $classes; ?> clearfix post large" <?php print $attributes; ?>>
	<section class="post-content feature-event">
    <header class="meta">
        <div class="blog-date">
            <span class="date-day"><?php print format_date($created,'custom','d');?></span>
		...
		<h4 class="blog-title"><a href="<?php print $node_url; ?>"><?php print $title; ?></a></h4>
    </header>
	<?php
    ...
    ?>
	    <a class="btn btn-inverse" href="<?php print $node_url; ?>"><?php print t('More');?></a> 
	</section>	
