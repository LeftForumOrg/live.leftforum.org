 ...
 */
?><!DOCTYPE html>
<html xmlns:og="http://opengraphprotocol.org/schema/" <?php print $html_attributes;?><?php print $rdf_namespaces;?>>
<head>
  ...
  <?php print $head; ?>
  <title><?php $a = 'Log in | ';
	if (strpos($head_title, $a) !== false) {
		$changed_head = str_replace($a, '', $head_title);
		print $changed_head;
	} else {
		print $head_title;
	} ?></title>
